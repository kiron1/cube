        ...
        function(add_scan_build _target)
			...
			"$<$<BOOL:$<TARGET_PROPERTY:${_target},SCANBUILD_DEFINES>>:-D$<JOIN:$<TARGET_PROPERTY:${_target},SCANBUILD_DEFINES>, -D>>"
                ...
                add_custom_target(${_target}
                        ...
                        COMMAND ScanBuild::scan-build ${_scanargs} ${CMAKE_COMMAND} --build "${_builddir}" "$<$<BOOL:$<TARGET_PROPERTY:${_target},SCANBUILD_BUILD_TYPE>>:--config $<TARGET_PROPERTY:${_target},SCANBUILD_BUILD_TYPE>>"
                )
